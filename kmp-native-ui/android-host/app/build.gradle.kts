...
android {
  namespace = "com.example.benchmark.kmpnativeui.host"
  compileSdk = 37

  defaultConfig {
    applicationId = "com.example.benchmark.kmpnativeui.host"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
dependencies {
  // The shared Kotlin logic. It carries no UI: the screen in this host is
  // plain Jetpack Compose.
  implementation("com.example.benchmark.kmpnativeui:reposearchkit:1.0.0")
